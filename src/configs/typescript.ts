...
export async function typescript(
	...
	function makeParser(
		...
		return {
			...
			name: `limitlesspc/typescript/${typeAware ? "type-aware-parser" : "parser"}`,
		};
	}
	...
	return [
		{
			...
			name: "limitlesspc/typescript/setup",
			plugins: {
				antfu: pluginAntfu,
				ts: pluginTs as any,
			},
		...
		{
			files: ["**/*.d.?([cm])ts"],
			name: "limitlesspc/typescript/disables/dts",
			rules: {
		...
		},
		{
			...
			name: "limitlesspc/typescript/disables/test",
			rules: {
				"no-unused-expressions": "off",
			},
		},
		{
			files: ["**/*.js", "**/*.cjs"],
			name: "limitlesspc/typescript/disables/cjs",
			rules: {
